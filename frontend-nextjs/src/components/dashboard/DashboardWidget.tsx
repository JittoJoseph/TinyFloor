...
export function DashboardWidget({
  ...
  if (variant === "compact") {
    return (
      <Link
        href="/dashboard"
        className="cursor-pointer group flex items-center gap-3 p-3 bg-[#fbfbf9] hover:bg-gray-50 rounded-xl border border-[rgba(0,0,0,0.06)] shadow-sm hover:-translate-y-0.5 transition-all"
      >
        {/* Mini Character */}
  ...
  return (
    <Link
      href="/dashboard"
      className="cursor-pointer group block bg-[#fbfbf9] hover:bg-gray-50 rounded-2xl border border-[rgba(0,0,0,0.06)] shadow-sm hover:-translate-y-0.5 transition-all overflow-hidden"
    >
      {/* Header */}
      <div className="p-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className="w-14 h-16 bg-white rounded-xl border border-[rgba(0,0,0,0.06)] flex items-center justify-center overflow-hidden">
            <CharacterPreview
              characterId={characterId}
              size="sm"
              showShadow={false}
