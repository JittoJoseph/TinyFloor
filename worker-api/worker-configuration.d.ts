/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 683f5f77cfddd16f28218c3bfc882e4c)
// Runtime types generated with workerd@1.20260915.1 2026-09-01 
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_LIMIT: RateLimit;
	SITE_ORIGINS: "https://preview.tinyfloor.com,http://localhost:3000" | "https://www.tinyfloor.com,https://preview.tinyfloor.com,http://localhost:3000";
	SESSION_COOKIE: "tf_preview_session" | "tf_session";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PasswordGuard";
	}
	interface PreviewEnv {
		...
		TURN_KEY_API_TOKEN: string;
		PASSWORD_GUARD: DurableObjectNamespace<import("./src/index").PasswordGuard>;
		REALTIME: Service /* entrypoint RealtimeAdmin from tinyfloor-realtime-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGINS" | "SESSION_COOKIE" | "TICKET_SECRET" | "TURNSTILE_SECRET" | "COOKIE_DOMAIN" | "REALTIME_URL" | "TURN_KEY_ID" | "TURN_KEY_API_TOKEN">> {}
}
