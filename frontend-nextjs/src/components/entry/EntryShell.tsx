...
export const inputClass =
  "w-full h-12 px-4 rounded-xl bg-background border border-border text-[16px] sm:text-[15px] text-foreground placeholder:text-faint outline-none transition-[border-color,box-shadow] duration-200 focus:border-border-strong focus:ring-4 focus:ring-ring/15";
