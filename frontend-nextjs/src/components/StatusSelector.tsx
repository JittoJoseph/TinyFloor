...
const STATUS_OPTIONS = [
  { value: "available", color: "bg-emerald-500", bgColor: "bg-emerald-50" },
  { value: "busy", color: "bg-red-500", bgColor: "bg-red-50" },
  { value: "away", color: "bg-amber-500", bgColor: "bg-amber-50" },
] as const;
...
export const StatusSelector: React.FC<StatusSelectorProps> = ({
  ...
  const currentOption =
    ...
    STATUS_OPTIONS[0];
  const statusLabel = tControls("status", {
    status: t(`${currentOption.value}.label`),
  });
